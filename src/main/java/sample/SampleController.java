...
/**
 *
 * A simple rest controller that will make a GRPC call to the server which is also hosted
...
public class SampleController {
	...
	public String hi(@PathVariable String name) throws Exception {
		...
		this.logger.debug("In the controller.");
		Thread.sleep(this.random.nextInt(1000));
		return this.helloClient.sayHello(name);
	}
